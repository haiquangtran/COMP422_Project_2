...
extends GPProblem {
	...
	public SymbolicRegressionProblem(GPConfiguration a_conf)
	...
	public static void main(String[] args)
		...
		config.setFitnessFunction(new SymbolicRegressionProblem.FormulaFitnessFunction());
		/**
		...
		GPProblem problem = new SymbolicRegressionProblem(config);
